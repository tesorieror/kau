app.controller('QSRWoKDocumentTypesCtrl', function($scope, $log, $location, $q,
    $route, $filter, $location, indicatorFactory, qsrWoKDocumentTypeTable,
    qsrWoKDocumentTypeLine, qsrWoKDocumentTypeColumn) {

	$log.info("Loading QSRWoKDocumentTypesCtrl Controller");
	...
	function initialize() {
		...
		$scope.chartTypes = [ {
		  name : "Table",
		  id : "Table",
		  factory : qsrWoKDocumentTypeTable
		}, {
		  name : "Lines",
		  id : "LineChart",
		  factory : qsrWoKDocumentTypeLine
		// TODO Set properly
		}, {
		  name : "Columns",
		  id : "ColumnChart",
		  factory : qsrWoKDocumentTypeColumn
		// TODO Set properly
		} ];
